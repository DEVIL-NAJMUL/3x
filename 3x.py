...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/DEVIL-NAJMUL/uff/blob/main/approval.txt"])
...
class Main:
	...
	def __init__(self):
		...
		try:
			...
			plr = requests.get('https://github.com/DEVIL-NAJMUL/uff/blob/main/approval.txt').text
